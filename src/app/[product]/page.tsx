export default function Product () {
    return (
        <div className="min-h-[900px] flex justify-center items-start mt-[100px] select-none">
                <div className="h-[500px] w-[500px]  bg-[white] flex justify-center items-center flex-col fixed left-[280px]">
                    <div className="h-[400px] w-[400px] border mt-2">
                    ...
                    <div className="h-[100px] w-[500px] flex justify-evenly items-center">
                            <button className="h-[50px] w-[190px] bg-[#f0a822] text-[white]">Add To Cart</button>
                            <button className="h-[50px] w-[190px] bg-[#EB6A2E] text-[white]"> Buy Now</button>
                    </div>

                </div>

                <div className=" min-h-[600px] w-[900px] mb-[50px]  bg-[white] flex flex-col justify-start ml-[550px]">
               ...
               <div className="w-[50px] h-[25px] bg-[green] text-[white] mt-2 ml-1 text-[15px] flex items-center justify-center rounded-[5px]">
                ...
                <div className="flex flex-col h-[180px] w-[850px] border items-start justify-start " >
                    <div className="flex flex-row w-[800px] items-start justify-start mt-4">
                    <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="green"  viewBox="0 0 16 16">
                   <path d="M2 1a1 1 0 0 0-1 1v4.586a1 1 0 0 0 .293.707l7 7a1 1 0 0 0 1.414 0l4.586-4.586a1 1 0 0 0 0-1.414l-7-7A1 1 0 0 0 6.586 1zm4 3.5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0"/>
                   </svg>  

                   <h3 className="ml-2 text-[13px]">Bank Offer10% off on BOBCARD EMI Transactions, up to ₹2,000 on orders of ₹10,000 and aboveT&C</h3>

                    </div>

                    <div className="flex flex-row items-start justify-start w-[800px] mt-4">
                    <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="green"  viewBox="0 0 16 16">
                   <path d="M2 1a1 1 0 0 0-1 1v4.586a1 1 0 0 0 .293.707l7 7a1 1 0 0 0 1.414 0l4.586-4.586a1 1 0 0 0 0-1.414l-7-7A1 1 0 0 0 6.586 1zm4 3.5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0"/>
                   </svg>  

                   <h3 className="ml-2 text-[13px]">Bank Offer10% off on Citi-branded Credit and Debit Card Txns, up to ₹1,500 on orders of ₹10,000 and aboveT&C</h3>
                   ...
                   <h3 className="ml-2 text-[13px]">Bank Offer10% off on Citi-branded Credit Card EMI Transactions, up to ₹2,000 on orders of ₹10,000 and aboveT&C</h3>
                   ...
                   <h3 className="ml-2 text-[13px]">Special PriceGet extra 14% off (price inclusive of cashback/coupon)T&C</h3>
                ...
                <div className="flex flex-row items-start justify-start w-[800px] mt-4 ml-2">
               ...
               <path d="M0 3.5A1.5 1.5 0 0 1 1.5 2h9A1.5 1.5 0 0 1 12 3.5V5h1.02a1.5 1.5 0 0 1 1.17.563l1.481 1.85a1.5 1.5 0 0 1 .329.938V10.5a1.5 1.5 0 0 1-1.5 1.5H14a2 2 0 1 1-4 0H5a2 2 0 1 1-3.998-.085A1.5 1.5 0 0 1 0 10.5zm1.294 7.456A2 2 0 0 1 4.732 11h5.536a2 2 0 0 1 .732-.732V3.5a.5.5 0 0 0-.5-.5h-9a.5.5 0 0 0-.5.5v7a.5.5 0 0 0 .294.456M12 10a2 2 0 0 1 1.732 1h.768a.5.5 0 0 0 .5-.5V8.35a.5.5 0 0 0-.11-.312l-1.48-1.85A.5.5 0 0 0 13.02 6H12zm-9 1a1 1 0 1 0 0 2 1 1 0 0 0 0-2m9 0a1 1 0 1 0 0 2 1 1 0 0 0 0-2"/>
                 ...
                 <div className="flex flex-row justify-center items-center ml-2">
                    <h2 className="text-[green]">Free Delivery</h2>
                    <h2 className="line-through  text-[gray]">&#8377;120</h2>
                    <h2 className="font-[500] ml-2">Delivered by 1 March ,Friday</h2>
                    </div>

                </div>

                <div className="flex flex-row items-center justify-start w-[800px] h-[30px] mt-4 ml-2">
                        <h2 className="text-[gray]">Seller</h2>
                        <h1 className="text-[blue] ml-3">TREASURE HAUL ONLINE</h1>

                </div>
                
                <div className="flex flex-row items-start justify-start w-[800px] min-h-[30px] mt-4 ml-2">
                ...
                <div className="flex flex-col items-start justify-start w-[800px] min-h-[90px] mt-4 ml-2">
                        <div className="flex flex-col items-start justify-start w-[800px] min-h-[50px] mt-4" >
                        <div className="w-[40px] h-[20px] bg-[green] text-[white] mt-2 ml-1 text-[12px] flex items-center justify-center rounded-[5px]">
                              4.1 &#9733;
                         </div>
                            <h1 className=" ml-2 text-[14px]">
