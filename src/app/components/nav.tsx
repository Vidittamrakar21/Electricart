  ...
  const handlebox = () => {
    ...
    return(
         ...
         <input type="search" placeholder="&nbsp; Search for products brand and more" className=" h-9 w-96 bg-[#CDF5FD] placeholder:text-grey rounded-lg sm1:hidden" onClick={opensearch} />
           ...
           <div className=" flex flex-row items-start justify-center cursor-pointer" onClick={opensign}>
            ...
            <div onClick={openorder} className={box? "h-[150px] w-[180px] sm1:right-[30px] bg-[white] select-none flex flex-col justify-center items-center fixed right-[500px] top-[60px] shadow-lg rounded-[8px] border" :"hidden"}>
